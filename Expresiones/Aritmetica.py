        ...
        try:
            ...
            if self.operador == OperadorAritmetico.MAS: #SUMA
                if self.OperacionIzq.tipo == TIPO.NULO:
                    return Excepcion("Semantico", "Error de operacion en variable NULA", self.fila, self.columna)
            ...
            return Excepcion("Semantico", "JPR NULL POINTER", self.fila, self.columna)
